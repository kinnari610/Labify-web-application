        ...
        <Card className="w-full max-w-md backdrop-blur-sm bg-white/80 border-0 shadow-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-xl"
            >
              Go to Login
            </Button>
          </CardContent>
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-2xl">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-gray-600">Join Labify for convenient health testing</CardDescription>
          </CardHeader>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
          ...
          <p className="text-xs text-blue-700">
            In demo mode, you can use any email/password or try Google Sign-In simulation.
          </p>
        </div>
      </div>
    </div>
